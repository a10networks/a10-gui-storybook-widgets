...
class Demo extends React.Component {
  ...
  render() {
    ...
    const desc = `Control filters and sorters by filteredValue and sortOrder.
    ...
    return (
      <CodeCard
        title="Reset filters and sorters"
        desc={desc}
        code={<Code string={demoCode} />}
      >
        <div className="table-operations">
          <A10Button onClick={this.setAgeSort}>Sort age</A10Button>
          <A10Button onClick={this.clearFilters}>Clear filters</A10Button>
          <A10Button onClick={this.clearAll}>
