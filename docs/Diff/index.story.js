...
import { CodeComponent } from '../utils'
import * as readme from '../../src/Diff/README.md'
...
const diffString = createPatch('virtual-server/vip-wildcard', json1, json2)
const Example = () => {
  return (
    <CodeComponent>
      <Demo1 diffString={diffString} />
      <Demo2 diffString={diffString} />
      <Demo3 />
    </CodeComponent>
  )
}
...
export default story => {
  story.add('A10Diff', withReadme(readme, Example))
}
