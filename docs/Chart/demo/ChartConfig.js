...
import { A10Col } from '../../../src';
const xAxisCategories = [1740, 1800, 1850, 1900, 1950, 1999, 2050]
const A10Colors = [
    '#109618',
    '#ff9900',
    '#dc3912',
...
export const areaConfigCounter = {
    total: 16344,
    filters: {
        'DDoS': 5268,
        'Malware': 1766,
...
export const groupColumnConfig = {
    ...
    tooltip: {
        ...
        pointFormat:
            '{series.name}: {point.y}<br/>Total: {Math.abs(point.stackTotal)}',
    },
    series: [{
        name: 'John',
        data: [5, 3, 4, 7, 2],
...
export const scatterConfigCounter = {
    total: 168,
    filters: {
        'Good': 156,
        'Suspicious': 124,
        'Infected': 110.38,
        'Failed': 104.77,
        'Other 1': _.random(100, 140),
        'Other 2': _.random(100, 140),
        'Other 3': _.random(100, 140),
        'Other 4': _.random(100, 140),
        'Other 5': _.random(100, 140),
        'Other 6': _.random(100, 140),
        'Other 7': _.random(100, 140),
    }
}

export const columnConfigSingle = {
    chart: {
        type: 'column'
    },
    title: {
...
export const columnConfigSingleCounter = {
    total: 168,
    filters: {
        'Good': 156,
        'Suspicious': 124,
