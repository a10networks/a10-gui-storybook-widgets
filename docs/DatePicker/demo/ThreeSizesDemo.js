    ...
    render() {
        ...
        return (
            <div>
                ...
                <br /><br />
                <A10DatePicker suffixIcon={<ComboIcons />} placeholder="Select Date" size={size} />
                <br />
                < A10MonthPicker suffixIcon={<ComboIcons />} size={size} placeholder="Select Month" />
                <br />
                < A10RangePicker suffixIcon={<ComboIcons />} size={size} />
                <br />
                < A10WeekPicker suffixIcon={<ComboIcons />} size={size} placeholder="Select Week" />
            </div>
        );
    }
}